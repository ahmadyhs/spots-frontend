        ...
        <body className="grid grid-cols-5">
            ...
            <aside className="bg-[#17224D] h-screen grid place-content-between">
                <div>
                    ...
                    <button className="bg-slate-500 w-full text-white text-left font-semibold p-3 my-1 hover:bg-blue-600 active:bg-slate-500">Data Coworking</button>
                </div>
                    ...
                    <table className="m-10 w-11/12"> 
                        <thead>
                            <tr className="bg-[#3C4158] text-center">
                                ...
                                <th className="p-2 w-2/12 border border-black">Nama</th>
                                <th className="p-2 w-1/12 border border-black">Harga Sewa</th>
                                <th className="p-2 w-3/12 border border-black">Fasilitas</th>
