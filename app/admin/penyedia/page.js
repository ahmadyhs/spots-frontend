        ...
        <body className="grid grid-cols-5">
            ...
            <aside className="bg-[#17224D] h-screen grid place-content-between">
                <div>
                    ...
                    <button className="bg-slate-500 w-full text-white text-left font-semibold p-3 my-1 hover:bg-blue-600 active:bg-slate-500">Data Penyedia</button>
                    ...
                    <table className="m-10 w-11/12"> 
                        <thead>
                            <tr className="bg-[#3C4158] text-center">
                                ...
                                <th className="p-2 w-1/12 border border-black">Nama Depan</th>
                                <th className="p-2 w-1/12 border border-black">Nama Belakang</th>
                                <th className="p-2 w-1/12 border border-black">Email</th>
                                <th className="p-2 w-1/12 border border-black">Nomor Telepon</th>
                                <th className="p-2 w-1/12 border border-black">Bank</th>
                                <th className="p-2 w-1/12 border border-black">Nomor Kartu</th>
                                <th className="p-2 w-2/12 border border-black">NIK</th>
                                <th className="p-2 w-2/12 border border-black">KTP</th>
                                <th className="p-2 w-1/12 border border-black">Status</th>
                            </tr>
                        </thead>
                        <tbody>
