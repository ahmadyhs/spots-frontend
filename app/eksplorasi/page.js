      ...
      <body className='bg-white'>
        ...
        <div className='flex bg-gray-100 p-2 my-5 mx-12 border border-[#17224D] rounded-xl'>
          <div className="w-2/5 py-5 px-5 flex justify-center">
            <Image alt='room' src="/room.png" className='max-h-full max-w-full' width={200} height={100} />
          </div>
          ...
          <div className='w-1/5 px-2 flex items-center'>
            <div>
              <Link type="submit" class="block bg-teal-500 hover:bg-blue-400 text-white font-semibold rounded-full
                px-10 py-3 my-3 w-full text-center" href='/detail'>Lihat Detail</Link>
              <Link type="submit" class="block bg-blue-950 hover:bg-blue-400 text-white font-semibold rounded-full
        ...
        <div className='flex bg-gray-100 p-2 my-5 mx-12 border border-[#17224D] rounded-xl'>
          <div className="w-2/5 py-5 px-5 flex justify-center">
            <Image alt='room' src="/room2.png" className='max-h-full max-w-full' width={200} height={100} />
          </div>
